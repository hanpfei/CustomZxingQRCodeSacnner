...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(ScanModule scanModule, Map<DecodeHintType, Object> hints) {
        multiFormatReader = new MultiFormatReader();
        multiFormatReader.setHints(hints);
        mScanModule = scanModule;
    }
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = mScanModule.getCameraManager()
        ...
        Handler handler = mScanModule.getHandler();
        if (rawResult != null) {
