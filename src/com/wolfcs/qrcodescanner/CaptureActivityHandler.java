...
public final class CaptureActivityHandler extends Handler {
    ...
    private final ScanModule mScanModule;
    ...
    CaptureActivityHandler(Activity activity, ScanModule scanModule,
            Collection<BarcodeFormat> decodeFormats,
            Map<DecodeHintType, ?> baseHints, String characterSet,
            CameraManager cameraManager) {
        this.activity = activity;
        this.mScanModule = scanModule;
        decodeThread = new DecodeThread(scanModule, decodeFormats, baseHints,
                characterSet, new ViewfinderResultPointCallback(
                        scanModule.getViewfinderView()));
        decodeThread.start();
        state = State.SUCCESS;
    ...
    public void handleMessage(Message message) {
        ...
        case R.id.decode_succeeded:
            ...
            mScanModule.handleDecode((Result) message.obj, barcode, scaleFactor);
            break;
